...
//            int idVendedor;
//            if (Login.getInstanciaLogin().verificaVendedorParaVenda() == -1) {
//                while (true) {
//                    try {
...
//
//                if (idVendedor == 0) {
//                    Menu.getInstanciaMenu().escolhaMenuVendas();
//                }
//            } else  {
//                idVendedor = Login.getInstanciaLogin().verificaVendedorParaVenda();
//            }
//
...
//                            System.out.println(ControladorEstoque.getInstanciaEstoque().diminuiQuantidadeEstoqueVenda(p));
...
//            System.out.println("entidades.Venda desativada: não existem produtos na lista.");
//        } else {
...
//        comissaoVendedor();
//        System.out.println("entidades.Venda cadastrada com sucesso com o ID: "+v.getIdVenda());
//        System.out.println("==================================================================");
//    }
//
...
//
//        // Verificar permissão
//        int idVendedorLogado = Login.getInstanciaLogin().verificaVendedorParaVenda();
//
...
//        boolean ehGerente =
//                Objects.equals(
//                        Login.getInstanciaLogin().verificaGerenteDeVendasParaVenda().toLowerCase(),
//                        "gerente de vendas"
//                );
//
...
//                            System.out.println(ControladorEstoque.getInstanciaEstoque().alteraDiminuiQuantidadeEstoqueVenda(p, alteraEstoque));
//                        } else if (p.getQuantidade() > novaQuant) {
//                            ControladorEstoque.getInstanciaEstoque().alteraAumentaQuantidadeEstoqueVenda(p,alteraEstoque);
//                        }
//
...
//                        ControladorEstoque.getInstanciaEstoque().alteraAumentaQuantidadeEstoqueVenda(p,p.getQuantidade());
//                        it.remove();
...
//                    System.out.println("entidades.Venda desativada: não restam produtos na lista.");
//                } else {
//                    if (!vendaEncontrada.getVendaAtiva()) {
//                        System.out.println("entidades.Venda reativada.");
...
//        comissaoVendedor();
//        System.out.println("entidades.Venda alterada com sucesso.");
//        System.out.println("==================================================================");
//    }
//
...
//                    v.setVendaAtiva(false);
//                    comissaoVendedor();
//                    System.out.println("entidades.Venda cancelada com sucesso.");
//                }
//            }
//        }
//        if (!existeVenda) {
...
//            }
//        }
//        System.out.print("ID entidades.Cliente: " + v.getIdClienteVenda()+" - ");
